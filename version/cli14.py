...
# ------------------------------------------------ #
    try:
        ...
        summary_lines = [
            ...
            f"MAPE: {mean_percent_error:.2f}%",  # <-- MAPE added
...
python3 cli14.py --log --normdist --intrv 1d --smooth 1008 --pe --div --compare --vs --start 1900-01-01 --end 2100-01-01 --csv

--COMPAREX
python3 cli14.py --comparex nvda --vs amd msft adi --pe --log --normdist --intrv 1d --smooth 1008 --start 1900-01-01 --end 2100-01-01 --csv
python3 cli14.py --comparex nvda --vs amd msft adi --pe
python3 cli14.py --comparex eix --vs pcg sre duk nee so --pe
