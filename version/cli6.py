...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Logarithmic regression analysis for stock tickers.',add_help=False  # disables auto -h/--help
)
...
if pre_args.help:
    ...
    Optional Arguments:
      ...
      --compare(x)-self-ticker-group         Compare(x's) one or all tickers to either -self or a specific ticker or group of tickers on any defined optional arguments metrics such as sd, pergl, div, pe and saves this analysis to a PNG chart and CSV
      --sd                    Output standard deviations from mean and summary
      --pergl                 Display percent gain/loss over the selected date range
    ...
    Example:
      python3 script.py SPY GOLD USD-BTC --intrv 1d --smooth 252 --pergl --div --pe --sd --compare --top10 --start 1900-01-01 --end 2100-01-01
